...
func (app *application) routes() http.Handler {
	...
	router.Handler(http.MethodGet, "/follow/{id}", app.Authenticator(http.HandlerFunc(app.Follow)))
	...
	router.Handler(http.MethodGet, "/unfollow/{id}", app.Authenticator(http.HandlerFunc(app.Unfollow)))
